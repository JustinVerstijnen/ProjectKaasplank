...
<section class="about-section about-section-person">
  <div class="about-section-header">
    <p class="about-eyebrow">Information about me</p>
  ...
  <div class="about-feature-grid">
    <article class="about-feature-card about-feature-card-large">
    ...
    <article class="about-feature-card">
      <div class="about-card-icon" aria-hidden="true">✈</div>
      <h3>Outside IT</h3>
      <p>Besides cloud and security, I enjoy aviation, photography, guitar, gaming, building PCs, darts, fitness and football.</p>
    </article>
  </div>
...
<section class="about-section about-certifications-section">
  <div class="about-section-header">
    <p class="about-eyebrow">Certifications</p>
    <h2>Microsoft, networking and IT fundamentals.</h2>
    <p>A collection of certifications and exams that supported my path through Microsoft Cloud, security, infrastructure and networking.</p>
  </div>
...
<section class="about-section about-section-site">
  <div class="about-section-header">
    <p class="about-eyebrow">Information about the website</p>
  ...
  <div class="about-feature-grid about-site-grid">
    <article class="about-feature-card">
      <div class="about-card-icon" aria-hidden="true">◇</div>
    ...
    <article class="about-feature-card">
      ...
      <p>The latest public repository updates are loaded below directly from GitHub.</p>
    </article>
  </div>

  <div class="about-build-card">
    <div>
      <p class="about-eyebrow">Build information</p>
      <h3>Site build details</h3>
    </div>
